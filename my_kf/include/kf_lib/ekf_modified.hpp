...
#ifndef EKF_MODIFIED_HPP_
#define EKF_MODIFIED_HPP_
...
public:
  ...
  void Init(Eigen::VectorXd &x_in, Eigen::MatrixXd &P_in, Eigen::MatrixXd &F_in,
            Eigen::VectorXd &u_in, Eigen::MatrixXd &B_in, Eigen::MatrixXd &H_in,
  ...
  void ApplyReliabilityFunction(Eigen::VectorXd &residual);
...
private:
  ...
  std::function<Eigen::VectorXd(const Eigen::VectorXd &)>
      f_; // Non-linear State transition function
  std::function<Eigen::VectorXd(const Eigen::VectorXd &)>
      h_; // Non-linear measurement function (Jacobian)
